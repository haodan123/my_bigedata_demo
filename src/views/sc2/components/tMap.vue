<template>
  <div class="map_box">
    ...
    <div class="map_leftdd">
      <div class="map_left_item">
        <img src="@/assets/sc2/szicon.png" mode="scaleToFill" />
        <div class="map_left_item_text">
          <div class="light_text">水质传感器</div>
          <div>
            <span class="weight_text">{{ '5213' }}</span>个
          </div>
        </div>
      </div>
      <div class="map_left_item">
        <img src="@/assets/sc2/bsicon.png" mode="scaleToFill" />
        <div class="map_left_item_text">
          <div class="light_text">补水设备</div>
          <div>
            <span class="weight_text">{{ '5213' }}</span>个
          </div>
        </div>
      ...
      <div class="map_left_item">
        <img src="@/assets/sc2/zyjicon.png" mode="scaleToFill" />
        <div class="map_left_item_text">
          <div class="light_text">增氧机</div>
          <div>
            <span class="weight_text">{{ '404' }}</span
            >个
          </div>
        </div>
      </div>
      <div class="map_left_item">
        <img src="@/assets/sc2/tejicon.png" mode="scaleToFill" />
        <div class="map_left_item_text">
          <div class="light_text">投饵机</div>
          <div>
            <span class="weight_text">{{ '322' }}</span
            >个
          </div>
        </div>
      </div>
