<template>
  ...
  <div class="page_title">
    <!-- <img src="@/assets/global_sc/header_left.png" alt="" class="title_left_img" /> -->
    <div class="title_left_text">
      <img class="title_left_text_img" src="@/assets/global_sc/header_left.png"></img>
      <!-- <img src="@/assets/global_sc/yztextimg.png" alt="" class="title_left_text_name"> -->
      <!-- <img src="@/assets/global_sc/yztextimg.png" alt="" class="title_left_text_name"> -->
...
.title_mid_btn_item {
  ...
  // text-align: center;
  &:hover {
    text-shadow: 0 0 3px #5e8fce, 0 0 3px #5e8fce, 0 0 3px #5e8fce, 0 0 3px #5e8fce;
  }
}
.active {
  color: #1ee2e3;
